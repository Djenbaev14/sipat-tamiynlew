function previewFile() {
  ...
  (async () => {
    ...
    function stop() {
      ...
      const audioInputt = document.querySelector('#audioInput');

      const audioFile = new File([blob], 'recordedAudio.wav', { type: 'audio/wav' });

      // Create a FormData object and append the File
      const formData = new FormData();
      formData.append('audioFile', audioFile);

      // Set the FormData object to the file input
      audioInputt.file = formData;
